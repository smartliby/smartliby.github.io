...
![](/images/media/选区_026.png)

4.进入Theme，修改为Flatabulous
![](/images/media/Unity Tweak Tool_027.png)

5.在此界面下进入Icons栏，修改为Ultra-flat
![](/images/media/Unity Tweak Tool_028.png)
...
chsh -s /usr/bin/zsh
```
![](/images/media/liby@kingsoft:%20~_031.png)
# 安装terminator
...
![](/images/media/Settings_033.png)
![](/images/media/Settings_034.png)
...
![](/images/media/dconf 系统配置编辑器_030.png)

之后就可以在其他的电脑上使用远程桌面登录了

# 16.04默认没有打开工作区切换功能需要手动打开，使用起来方便多了。
![](/images/media/Unity Tweak Tool_039.png)
![](/images/media/工作区_041.png)

# 最终的效果图
![](/images/media/工作区 1_076.png)
![](/images/media/工作区 1_077.png)
